...
UPDATE_LINUX="true"
```
- you can make an update_all.sh with its [update_all.ini](https://github.com/theypsilon/Updater_script_MiSTer_DB9/blob/master/examples/update_all.ini?raw=true) using these settings:
```
UPDATE_CHEATS="true"
UPDATE_LINUX="true"
ADDITIONAL_REPOSITORIES+=( "https://github.com/MiSTer-devel/Fonts_MiSTer|pf|$BASE_PATH/font" )
